        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-slate-400 max-w-xl">
              Predict fish weight based on environmental conditions, feeding strategy, and stocking density.
            </p>
          </div>
        </div>

        {/* RIGHT: STATUS / INSIGHT */}
...
export default GrowthPredictionHeader;